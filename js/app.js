(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".main-slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            new swiper_core_Swiper(".lots__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".control-slider-lots__arrow--left",
                    nextEl: ".control-slider-lots__arrow--right"
                },
                breakpoints: {
                    480: {
                        slidesPerView: 2,
            ...
            new swiper_core_Swiper(".quotes__slider", {
                ...
                navigation: {
                    nextEl: ".control-slider-qoutes__link"
                },
                on: {}
            });
        }
